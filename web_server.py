...
#                      forecast_conf_int.iloc[:, 0], forecast_conf_int.iloc[:, 1], color='pink')
...
def model_run():
    ...
    x1 = [[Store, Dept, Year, Month, IsHoliday, Type, Size, Temperature, Fuel_Price,
    ...
    #     SARIMA_result = SARIMA_model_run(
    #         DataFrame=df, Store=Store, Month=Month, Year=Year)
